...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('homeAssets/assets/bootstrap/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Montserrat:400,400i,700,700i,600,600i&amp;display=swap">
    <link rel="stylesheet" href="{{ URL::asset('homeAssets/assets/fonts/fontawesome-all.min.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('homeAssets/assets/fonts/simple-line-icons.min.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('homeAssets/assets/css/Diagonal-div-section.css') }}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/baguettebox.js/1.11.1/baguetteBox.min.css">
    <link rel="stylesheet" href="{{ URL::asset('homeAssets/assets/css/vanilla-zoom.min.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('homeAssets/assets/css/style.css') }}">
    @yield('css')
</head>

<body>
    <nav class="navbar navbar-dark navbar-expand-lg fixed-top clean-navbar" style="box-shadow: none !important;">
   ...
   @yield('content')
    ...
    <script src="{{ URL::asset('homeAssets/assets/js/vanilla-zoom.js') }}"></script>
    <script src="{{ URL::asset('homeAssets/assets/js/theme.js') }}"></script>
    @yield('js')
    ...
    <script src="{{ URL::asset('homeAssets/assets/vendors/glightbox/js/glightbox.min.js') }}"></script>
